    ...
    <Card className="p-3 bg-gradient-to-br from-rose-50 to-white border-2 border-[#F5E6D3] shadow-xl max-w-3xl w-full">
      ...
      <div className="space-y-2 w-full">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <TableCell name="Connecticut Ave" alternate={true} className="w-full" />
        </div>
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <div className="col-span-3 space-y-2">
            <div className="grid grid-cols-3 gap-2">
              <TableCell name="River Heights" alternate={false} className="w-full" />
              <TableCell name="Lakewood Drive" alternate={true} className="w-full" />
              <TableCell name="College Ave" alternate={false} className="w-full" />
            </div>
            <div className="grid grid-cols-3 gap-2">
              <TableCell name="Nerudova" alternate={true} className="w-full" />
              <TableCell name="Topping Drive" alternate={false} className="w-full" />
              <TableCell name="115th Street" alternate={true} className="w-full" />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <TableCell name="53rd Street" alternate={true} className="w-full" />
        </div>
      </div>
